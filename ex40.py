...
def central_corridor():#中心走廊
    ...
    if action == "shoot!":
        ...
        print ("Lbhe zbgure vf fb sng, jura fur fvfg nebhaq gur buhfr, fur fvfg nebhaq gur ubhf ...")
...
def laser_weapon_armory():
    ...
    print ("wrong 10 times then the lock close forever and you can't")
...
def escape_pod():
    ...
    if int(guess) != good_pod:
        ...
        print ("implode as the hull ruptures, crushing your body")
